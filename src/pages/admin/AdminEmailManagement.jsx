            ...
            <div className="p-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <span
                    className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${getStatusBadge(selectedEmailDetail.status)}`}
                  >
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-900">
                    {formatDate(selectedEmailDetail.created_at)}
                  </p>
                </div>
