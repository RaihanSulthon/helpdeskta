  ...
  useEffect(() => {
    ...
    if (user) {
      setUserInfo({
        ...
        registeredDate: user.registeredDate || new Date().toLocaleDateString('id-ID', {
          day: '2-digit',
          month: 'long', 
          year: 'numeric'
        })
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            >
              ...
              <svg className={`w-4 h-4 text-white transform transition-transform duration-300 ease-out ${
            ...
            {/* Dropdown Menu */}
            {isDropdownVisible && (
              <div className={`absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-xl z-50  transform transition-all duration-300 ease-out origin-top-right ${
                showUserDropdown 
                ...
                <div className="p-6">
                  <h3 className={`text-lg font-semibold text-gray-800 mb-4 transition-all duration-500 delay-100 ${
                  ...
                  {/* Email Field */}
                  <div className={`mb-4 transition-all duration-500 delay-150 ${
                    showUserDropdown ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
                  }`}>
