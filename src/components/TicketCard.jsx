    ...
    >
      ...
      <div className="flex items-center justify-between mb-1">
        <div className="text-blue-800 text-xs font-semibold">
          {((ticketData?.submitter || ticket.sender || "Tidak diketahui").length > 10
            ? (ticketData?.submitter || ticket.sender || "Tidak diketahui").slice(0, 10) + "..."
        ...
        <div className="flex items-center justify-between flex-1 ml-4">
          <span className="text-gray-600 text-xs mx-auto">
            {(ticketData?.email || ticket.email || "Email tidak tersedia").length > 25
          ...
          <span className="text-gray-600 flex items-center gap-1 text-xs">
            <svg viewBox="0 0 14 14" className="w-3 h-3" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="flex items-center space-x-2 mb-3">
        ...
        <span className="text-gray-600 text-sm">{ticketData?.category || "Umum"}</span>
      </div>

      {/* Ticket Title */}
      <div className="text-blue-800 font-bold text-lg mb-4">
        {ticketData 
          ? (ticketData.title || "TAK Belum Kunjung Lorem Ipsum TAK Belum Kunjung Lorem Ipsum ...")
          : (ticket.subject || "TAK Belum Kunjung Lorem Ipsum TAK Belum Kunjung Lorem Ipsum ...")
        }
      </div>
      ...
      <div className="flex items-center justify-between">
        ...
        >
          <svg viewBox="0 0 16 20" fill="none" className="w-4 h-4">
            <path d="M10.5 0.5V1.61133H15.5V2.83301H14.5V17.7773C14.5 18.271 14.346 18.6742 14.041 19.0137C13.738 19.3509 13.3995 19.5005 13.001 19.5H3C2.60175 19.5 2.26319 19.3504 1.95996 19.0137C1.65522 18.6751 1.50056 18.272 1.5 17.7773V2.83301H0.5V1.61133H5.5V0.5H10.5ZM4.5 16.0557H7.5V5.05566H4.5V16.0557ZM8.5 16.0557H11.5V5.05566H8.5V16.0557Z" fill="#444746" stroke="#444746"/>
          </svg>
        </button>
      </div>
